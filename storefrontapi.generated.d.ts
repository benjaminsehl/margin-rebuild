...
> & {
  ...
  keyBenefits?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  details?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  ingredientsHeadline?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'value'>
  >;
  keyIngredients?: StorefrontAPI.Maybe<{
  ...
  fullIngredients?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
...
export type StockistsQueryVariables = StorefrontAPI.Exact<{
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
}>;

export type StockistsQuery = {
  stockists: {
    nodes: Array<{
      company?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.MetaobjectField, 'value'>
      >;
      ...
      address?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.MetaobjectField, 'value'>
      >;
      website?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.MetaobjectField, 'value'>
      >;
      map?: StorefrontAPI.Maybe<Pick<StorefrontAPI.MetaobjectField, 'value'>>;
    }>;
  };
};
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  #REQUIRED_VAR=ProductCard.Fragment\n  query Collection(\n    $handle: String!\n    $country: CountryCode\n    $language: LanguageCode\n    $first: Int\n    $last: Int\n    $startCursor: String\n    $endCursor: String\n  ) @inContext(country: $country, language: $language) {\n    collection(handle: $handle) {\n      id\n      handle\n      title\n      description\n      products(\n        first: $first,\n        last: $last,\n        before: $startCursor,\n        after: $endCursor\n      ) {\n        nodes {\n          ...ProductCard\n        }\n        pageInfo {\n          hasPreviousPage\n          hasNextPage\n          endCursor\n          startCursor\n        }\n      }\n    }\n  }\n': {
  ...
  '#graphql\n  query Stockists(\n    $language: LanguageCode,\n    $country: CountryCode,\n  )\n  @inContext(language: $language, country: $country) {\n    stockists: metaobjects(type:"stockists" first:250) {\n      nodes {\n        company: field(key:"company") {\n          value\n        }\n        city: field(key:"city") {\n          value\n        }\n        country: field(key:"country") {\n          value\n        }\n        address:field(key:"address") {\n          value\n        }\n        website:field(key:"website") {\n          value\n        }\n        map: field(key:"google_maps_link") {\n          value\n        }\n      }\n    }\n  }\n': {
    return: StockistsQuery;
    variables: StockistsQueryVariables;
  };
}
